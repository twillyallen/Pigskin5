...
const _BASE = [
  ...
  { question: "Which Super Bowl was the first to go to overtime?", choices: ["Super Bowl LI", "Super Bowl XLVII", "Super Bowl LI", "Super Bowl LV"], answer: 0 },
  ...
  { question: "Which QB threw for the most yards in a single game (regular season)?", choices: ["Drew Brees", "Norm Van Brocklin", "Philip Rivers", "Nick Foles"], answer: 0 },
  ...
  { question: "Which safety is known for 'The Hit Heard 'Round the World' against WR Earl Thomas's...? (Who holds the career interceptions record among safeties?)", choices: ["Ed Reed", "Ronnie Lott", "Paul Krause", "Dick LeBeau"], answer: 2 },
  ...
  { question: "Which player returned a kickoff for a touchdown in Super Bowl XLIV?", choices: ["Devin Hester", "Jacoby Jones", "Percy Harvin", "Leon Washington"], answer: 1 },
